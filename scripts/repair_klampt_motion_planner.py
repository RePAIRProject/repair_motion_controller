...
class RepairMotionPlanner:
    ...
    def update_planner_robot_joint_states(self, joint_configs:List):
        """  
        Given joint joint_configs of the robot as a list, 
        this function update the real robot configuration in the vis.
        ...
        for index, val in enumerate(joint_configs) :
            self.planner_robot.driver(index).setValue(val)
    ...
    def get_plan_to_joint_goal_short(
        self, 
        start_config,
        goal_config,
        planner:str ='sbl'
